...
options_ = [];
M_.fname = 'Gali_2015_chapter_5_commitment_ZLB_ar1';
...
diary off;
diary('Gali_2015_chapter_5_commitment_ZLB_ar1.log');
M_.exo_names = 'eps_rn';
...
erase_compiled_function('Gali_2015_chapter_5_commitment_ZLB_ar1_static');
erase_compiled_function('Gali_2015_chapter_5_commitment_ZLB_ar1_dynamic');
M_.orig_eq_nbr = 9;
M_.eq_nbr = 9;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state( 8 ) = 4*oo_.steady_state(3);
...
axis([0 16 -1 5])
save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Gali_2015_chapter_5_commitment_ZLB_ar1_results.mat', 'oo_recursive_', '-append');
end
