function [residual, g1, g2, g3] = Gali_2015_chapter_5_commitment_ZLB_ar1_static(y, x, params)
%
...
residual(2)= lhs-rhs;
residual(3) = y(1)+y(6)-y(6)-1/(params(2)*params(3))*y(7);
residual(4) = y(7)+y(2)*vartheta__-kappa__*y(6)-y(7)*1/params(2);
residual(5) = y(7)/params(3);
lhs =y(4);
rhs =y(9)*4;
residual(6)= lhs-rhs;
lhs =y(5);
